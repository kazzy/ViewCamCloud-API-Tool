...
class VccBlobPostBlobServiceImageDownload(VccReqResBase):
    """
        BLOB > [POST] 画像
    """
    def __init__(self, parent, grid):
        """
            UIを設定する
        """
        super(VccBlobPostBlobServiceImageDownload, self).__init__(parent, grid)
    ...
    def communicate(self):
        ...
        payload = {
            "Request": "BlobServiceImageDownload"
        }
