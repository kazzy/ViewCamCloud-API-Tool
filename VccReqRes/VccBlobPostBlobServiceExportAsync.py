...
class VccBlobPostBlobServiceExportAsync(VccReqResBase):
    """
        BLOB > [POST] エクスポート
    """
    def __init__(self, parent, grid):
        """
            UIを設定する
        """
        super(VccBlobPostBlobServiceExportAsync, self).__init__(parent, grid)
    ...
    def set_defaultUI_request_Param(self):
        ...
        item2 = QtGui.QTreeWidgetItem(item)
        item2.setText(0, "codec")
        item2.setText(1, confv("codec"))
        item2.setFlags(QtCore.Qt.ItemIsEnabled | QtCore.Qt.ItemIsEditable)
        item2.setExpanded(True)

        item2 = QtGui.QTreeWidgetItem(item)
        item2.setText(0, "ext")
        item2.setText(1, confv("ext"))
        item2.setFlags(QtCore.Qt.ItemIsEnabled | QtCore.Qt.ItemIsEditable)
        item2.setExpanded(True)

        item2 = QtGui.QTreeWidgetItem(item)
        item2.setText(0, "fps")
        item2.setText(1, confv("fps"))
        item2.setFlags(QtCore.Qt.ItemIsEnabled | QtCore.Qt.ItemIsEditable)
        item2.setExpanded(True)
    ...
    def communicate(self):
        ...
        payload = {
            "Request": "BlobServiceExportAsync"
        }
